...
.bd-placeholder-img {
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    ...
    <form class="form-inline my-2 my-lg-0">
      <input type="text" placeholder="Search" name="referal" value="" class="who"  autocomplete="off">
...
<script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>
    ...
    <a href="#up" class="btn btn-warning topNubex">GO UP</a>
  </body>
...
<?php /**PATH C:\MAMP\htdocs\shop\resources\views/layouts/main.blade.php ENDPATH**/ ?>