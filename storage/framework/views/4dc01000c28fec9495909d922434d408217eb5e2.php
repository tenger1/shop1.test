...
<div class="dropdown">
  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault" >
    <ul class="navbar-nav mr-auto">
        ...
        <a class="nav-link bg-success btn mx-1 mb-2" href="/categories/11" style="text-align: center;"><strong style="font-variant:small-caps;"><?php echo app('translator')->get('main.autor-ziedi'); ?></strong></a>
         <a class="user nav-link bg-danger btn mx-1 mb-2" href="/login" style="text-align: center;"><strong style="font-variant:small-caps;"><?php echo app('translator')->get('main.ieiet'); ?></strong></a>
          <a class="user nav-link bg-danger btn mx-1 mb-2" href="/register" style="text-align: center;"><strong style="font-variant:small-caps;"><?php echo app('translator')->get('main.Reg'); ?></strong></a>
...
for($i = 0; $i < count($prices2); ++$i) {
  ...
  <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
        ...
        ?>
            ...
            <h5 class="text-center pt-2 mx-2 mb-2"><?php echo app('translator')->get('main.Hello'); ?>, <?=$_COOKIE['user']?>! </h5> 
  ...
  <path fill-rule="evenodd" d="M12.146 6.354l-2.5-2.5.708-.708 2.5 2.5-.707.708zM3 10v.5a.5.5 0 0 0 .5.5H4v.5a.5.5 0 0 0 .5.5H5v.5a.5.5 0 0 0 .5.5H6v-1.5a.5.5 0 0 0-.5-.5H5v-.5a.5.5 0 0 0-.5-.5H3z"/>
        ...
        <form name="idform" class="form-inline mt-2 mt-md-0" style=" position: relative; left:10px;">
            ...
            <input type="text" id="search" placeholder="<?php echo app('translator')->get('main.prece'); ?>..." class="form-control bg-light border-0 mb-2" small name="id">
    
    <input type="button" id="GFG_Button" class="btn btn-primary mx-1 mb-2" value="<?php echo app('translator')->get('main.Search'); ?>" onclick="location.href='/search/'+escape(document.forms['idform'].elements['id'].value)">
...
<script src="https://code.jquery.com/jquery-3.4.1.slim.min.js" integrity="sha384-J6qa4849blE2+poT4WnyKhv5vZF5SrPo0iEjwBvKU7imGFAV0wwj1yYfoRSJoZ+n" crossorigin="anonymous"></script>
      ...
      <a href="#" class="btn btn-warning topNubex" style="z-index: 10;"><?php echo app('translator')->get('main.up'); ?></a>
  </body>
...
</html><?php /**PATH C:\wamp64\www\shop\resources\views/welcome.blade.php ENDPATH**/ ?>