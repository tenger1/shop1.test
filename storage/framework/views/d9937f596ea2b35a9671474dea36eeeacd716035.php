...
<div class="cat_p">
    <div><img class= "product_image product_border" src="/images/<?php echo e($good->id); ?>.jpg" alt="Good image" [B]nocache[/B]></div>
    
                   <p> <?php echo app('translator')->get('main.nos'); ?>: <span class="nosaukums"><?php echo e($good->name); ?></span> </p>
                   <p> <?php echo app('translator')->get('main.Krāsa'); ?>: <span class="krasa"><?php echo e($good->color); ?></span> </p>
                   <p> <?php echo app('translator')->get('main.Valsts'); ?>: <span class="valsts"><?php echo e($good->country); ?></span> </p>
                   <p> <?php echo app('translator')->get('main.Apraksts'); ?>: <span class="apraksts"><?php echo e($good->description); ?></span> </p>
                   <p> <?php echo app('translator')->get('main.Cena'); ?>: <span class="cena" style="color:purple"><?php echo e($good->price); ?>€</span>/gb. </p> 
                   <p> Produkta kods (ID): <?php echo e($good->id); ?> </p>
				   
                   <form class="form-inline formorder" action="/add_action/"> 
                    <div class="form-group mb-2">
                        <label for="daudzums" style="color: #9c1402; font-size: 150%;"><?php echo app('translator')->get('main.cd'); ?></label>
                        <input type="number" class="form-control mx-1" name="daudzums" id="daudzums" placeholder="<?php echo app('translator')->get('main.cd'); ?>?" min="1" max="<?php echo e($go); ?>" required/><br>
                    <input style="display:none" type="radio" id="good_id" name="good_id" value="<?php echo e($good->id); ?>" checked>
                    </div>
  ...
  <path fill-rule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                    ...
                    <div class="container">
                     ...
                     <div class="container">
                        ...
                        <form action="/delete_by_id/" method="get" style="margin-left: 20px;">
                            <input style="display: none;" type="radio" name="del_id" id="del_id" value="<?php echo e($good->id); ?>" checked>
    ...
    $name = $good->name;
      ...
      ?>   
                     ...
                     <div class="table">
                     <table class="table">
                         <h2 style="font-variant: small-caps;"><?php echo app('translator')->get('main.in_your_cart'); ?>:</h2>
